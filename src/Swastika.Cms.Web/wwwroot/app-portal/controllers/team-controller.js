'use strict';
app.controller('TeamController', ['$scope', '$rootScope', '$timeout', '$location', 'authService', 'userServices', function ($scope, $rootScope, $timeout, $location, authService, userServices) {
