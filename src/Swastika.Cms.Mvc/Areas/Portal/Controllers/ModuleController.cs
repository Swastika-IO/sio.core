...
namespace Swastika.Cms.Mvc.Areas.Portal.Controllers
{
    ...
    public class ModuleController : BaseController<ModuleController>
    {
        ...
        {
            var Module = new ModuleBEViewModel(new SiocModule()
            {
        ...
        public async Task<IActionResult> Create(ModuleBEViewModel Module)
        {
        ...
        {
            var Module = await ModuleBEViewModel.Repository.GetSingleModelAsync(m => 
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, ModuleBEViewModel Module)
        {
            if (id != Module.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ModuleBEViewModel.Repository.CheckIsExists(m => m.Id == Module.Id))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            var Module = await ModuleBEViewModel.Repository.RemoveModelAsync(m => m.Id == id && m.Specificulture == _lang);
            return RedirectToAction("Index");
        }
        ...
        //    {
        //        var ModuleData = new ModuleContentViewmodel( 
        //            new SiocModuleData() {
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> AjaxSaveModuleData(ModuleContentViewmodel ModuleData)
        //{
        //    if (ModelState.IsValid)
        //    {
        ...
        {
            var getModule = await ModuleBEViewModel.Repository.GetSingleModelAsync
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> AddModuleData(ModuleContentViewmodel ModuleData)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            var ModuleData = await ModuleContentViewmodel.Repository.GetSingleModelAsync(
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> EditModuleData(ModuleContentViewmodel ModuleData)
        {
            if (ModelState.IsValid)
            {
                try
                ...
                {
                    if (!ModuleContentViewmodel.Repository.CheckIsExists(
        ...
        {
            var getData = await ModuleContentViewmodel.Repository.GetSingleModelAsync(m => m.Id == id);
            if (getData.IsSucceed)
            {
                var result = await ModuleContentViewmodel.Repository.RemoveModelAsync(m => m.Id == id && m.Specificulture== _lang);
                if (result.IsSucceed)
                {
