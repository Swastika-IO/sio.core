...
namespace Swastika.Cms.Lib.ViewModels.BackEnd
{
        ...
        : ViewModelBase<SiocCmsContext, SiocArticleModule, BEArticleModuleViewModel>
    {
        ...
        public override async Task<RepositoryResponse<bool>> RemoveRelatedModelsAsync(BEArticleModuleViewModel view, SiocCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
