...
{
    public class ApiTemplateViewModel
       : ViewModelBase<SiocCmsContext, SiocTemplate, ApiTemplateViewModel>
    {
        #region Properties
        ...
        public ApiTemplateViewModel()
            : base()
        {
        }

        public ApiTemplateViewModel(SiocTemplate model, SiocCmsContext _context = null, IDbContextTransaction _transaction = null)
