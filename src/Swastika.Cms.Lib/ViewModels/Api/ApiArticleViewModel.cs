...
{
    public class ApiArticleViewModel
        : ViewModelBase<SiocCmsContext, SiocArticle, ApiArticleViewModel>
    {
        #region Properties
        ...
        public ApiArticleViewModel() : base()
        {
        }

        public ApiArticleViewModel(SiocArticle model, SiocCmsContext _context = null, IDbContextTransaction _transaction = null) : base(model, _context, _transaction)
        {
        }
        ...
        public override void ExpandView(SiocCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
            ...
            var getView = ApiTemplateViewModel.Repository.GetSingleModel(t =>
                    t.TemplateId == themeId && t.FolderType == SWCmsConstants.TemplateFolder.Articles
            ...
            , SiocCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
            ...
            try
            {
                ...
                if (result.IsSucceed)
                {
                    ...
                    UrlAlias.Type = SWCmsConstants.UrlAliasType.Article;
        ...
        public override async Task<RepositoryResponse<bool>> CloneSubModelsAsync(ApiArticleViewModel parent, List<SupportedCulture> cloneCultures, SiocCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
        ...
        public override async Task<RepositoryResponse<bool>> RemoveRelatedModelsAsync(ApiArticleViewModel view, SiocCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
        ...
        public override RepositoryResponse<bool> RemoveRelatedModels(ApiArticleViewModel view, SiocCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
            RepositoryResponse<bool> result = new RepositoryResponse<bool>()
            {
                IsSucceed = true
        ...
        private void GenerateSEO()
        {
            ...
            int i = 1;
            string name = SeoName;
            while (ApiArticleViewModel.Repository.CheckIsExists(a => a.SeoName == name && a.Specificulture == Specificulture && a.Id != Id))
            {
                name = SeoName + "_" + i;
                i++;
            }
