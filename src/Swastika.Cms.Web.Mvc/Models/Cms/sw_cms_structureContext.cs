...
{
    public partial class sw_cms_structureContext : DbContext
    {
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer(@"Server=115.77.190.113,4444;Database=sw_cms_structure;UID=sa;Pwd=sqlP@ssw0rd;MultipleActiveResultSets=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SiocMedia>(entity =>
            {
                ...
                entity.Property(e => e.Specificulture)
                    .HasMaxLength(10)
                    .HasDefaultValueSql($"(N'{Lib.SWCmsConstants.Default.Specificulture}')");
