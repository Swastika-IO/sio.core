app.config(function ($routeProvider, $locationProvider, $sceProvider) {
    ...
    // Setting
    $routeProvider.when("/backend/setting/list", {
        controller: "SettingController",
        templateUrl: "/app-portal/pages/setting/list.html"
    });

    $routeProvider.when("/backend/setting/details/:id", {
        controller: "SettingController",
        templateUrl: "/app-portal/pages/setting/details.html"
    });

    $routeProvider.when("/backend/setting/create", {
        controller: "SettingController",
        templateUrl: "/app-portal/pages/setting/details.html"
    });
