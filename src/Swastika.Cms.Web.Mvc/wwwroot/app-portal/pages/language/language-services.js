'use strict';
app.factory('LanguageServices', ['$http', '$rootScope', 'CommonServices', function ($http, $rootScope, commonServices) {
    ...
    var _getLanguage = async function (id, type) {
        var apiUrl = '/api/' + settings.lang + '/language/';
    ...
    var _uploadLanguage = async function (languageFile) {
        ...
        if (languageFile.file !== undefined && languageFile.file !== null) {
            ...
            var req = {
                url: '/api/' + settings.lang + '/language/upload', //'/api/tts/UploadImage',
                type: "POST",
                headers: {
                },
