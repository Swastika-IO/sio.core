'use strict';
app.factory('ConfigurationServices', ['$http', '$rootScope', 'commonServices', function ($http, $rootScope, commonServices) {
    ...
    var _getConfiguration = async function (id, type) {
        var apiUrl = '/api/' + settings.lang + '/configuration/';
    ...
    var _uploadConfiguration = async function (configurationFile) {
        ...
        if (configurationFile.file !== undefined && configurationFile.file !== null) {
            ...
            var req = {
                url: '/api/' + settings.lang + '/configuration/upload', //'/api/tts/UploadImage',
                type: "POST",
                headers: {
                },
