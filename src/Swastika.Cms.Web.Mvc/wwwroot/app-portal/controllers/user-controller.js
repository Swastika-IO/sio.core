'use strict';
app.controller('userController', ['$scope', '$rootScope', 'ngAppSettings', '$timeout', '$location', 'AuthService', 'userServices', function ($scope, $rootScope, ngAppSettings, $timeout, $location, authService, userServices) {
