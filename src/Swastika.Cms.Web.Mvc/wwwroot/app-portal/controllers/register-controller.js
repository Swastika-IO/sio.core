'use strict';
app.controller('registerController', ['$scope', '$rootScope', 'ngAppSettings', '$timeout', '$location', 'AuthService', 'registerServices', function ($scope, $rootScope, ngAppSettings, $timeout, $location, authService, registerServices) {
    $scope.errors = [];
    $scope.selected = null;
