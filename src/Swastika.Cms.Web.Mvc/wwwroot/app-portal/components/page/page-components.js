(function (angular) {
    ...
    function PageDetailsController($scope, $element, $attrs) {
        ...
        ctrl.loadPage = function (pageId) {
            ctrl.isBusy = true;
            var url = '/api/' + ctrl.currentLanguage + '/page/details/be/' + pageId;//byPage/' + pageId;
        ...
        ctrl.loadPages = function (pageIndex) {
            ...
            var url = '/api/' + ctrl.currentLanguage + '/page/list';//byPage/' + pageId;
        ...
        ctrl.removePage = function (pageId) {
            if (confirm("Are you sure!")) {
                var url = '/api/' + ctrl.currentLanguage + '/page/delete/' + pageId;
                $.ajax({
                    method: 'GET',
                    url: url,
        ...
        ctrl.savePage = function (page) {
            var url = '/api/' + ctrl.currentLanguage + '/page/save';
            $.ajax({
                method: 'POST',
                url: url,
                data: page,
