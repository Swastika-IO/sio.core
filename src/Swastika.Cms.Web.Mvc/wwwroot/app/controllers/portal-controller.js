(function (angular) {
    'use strict';
    app.controller('PortalController', ['$scope', '$rootScope', '$http',
        function ($scope, $rootScope, $http) {
            ...
            $scope.initCms = function () {
                $http.post(serviceBase + 'api/portal/init-cms', JSON.stringify($scope.initCmsModel))
            ...
            $scope.loadUser = async function () {
                var response = await userServices.getUser(null, 'be');
                if (response.isSucceed) {
