    ...
    function ($scope, $rootScope, ngAppSettings, $timeout, $location, $http, commonService, step1Services) {
        ...
        $scope.settings = {
            cultures: [
                ...
                { specificulture: 'cs-cz', fullName: 'Ceská Republika - Ceština', icon: 'flag-icon-cz' },
                ...
                { specificulture: 'ro-md', fullName: 'Republica Moldova - Româna', icon: 'flag-icon-md' },
                { specificulture: 'ro-ro', fullName: 'România - Româna', icon: 'flag-icon-ro' },
                ...
                { specificulture: 'sl-si', fullName: 'Slovenija - Slovenšcina', icon: 'flag-icon-si' },
                ...
                { specificulture: 'vi-vn', fullName: 'Vi?t Nam - Tiê´ng vi?t', icon: 'flag-icon-vn' },
