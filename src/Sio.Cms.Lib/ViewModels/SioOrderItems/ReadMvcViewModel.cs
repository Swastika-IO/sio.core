...
namespace Sio.Cms.Lib.ViewModels.SioOrderItems
{
    public class ReadMvcViewModel
         : ViewModelBase<SioCmsContext, SioOrderItem, ReadMvcViewModel>
    {
        #region Properties
        ...
        public ReadMvcViewModel(SioOrderItem model, SioCmsContext _context = null, IDbContextTransaction _transaction = null)
