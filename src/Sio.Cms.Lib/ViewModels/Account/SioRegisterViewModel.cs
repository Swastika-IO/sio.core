...
{
    public class SioRegisterViewModel : ViewModelBase<SioCmsContext, SioCmsUser, SioRegisterViewModel>
    {
        #region Properties
        ...
        public SioRegisterViewModel() : base()
        {
        }

        public SioRegisterViewModel(SioCmsUser model, SioCmsContext _context = null, IDbContextTransaction _transaction = null)
