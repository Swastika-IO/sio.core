...
namespace Sio.Cms.Lib.ViewModels.Account.SioUsers
{
    public class UpdateViewModel : ViewModelBase<SioCmsContext, SioCmsUser, UpdateViewModel>
    {
        #region Properties
        ...
        public UpdateViewModel(SioCmsUser model, SioCmsContext _context = null, IDbContextTransaction _transaction = null)
        ...
        {
            using (SioCmsAccountContext context = new SioCmsAccountContext())
            {
