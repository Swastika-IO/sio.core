...
namespace Sio.Cms.Lib.ViewModels.SioLanguages
{
    public class ReadAndroidViewModel
       : ViewModelBase<SioCmsContext, SioLanguage, ReadAndroidViewModel>
    {
        #region Properties
        ...
        public ReadAndroidViewModel(SioLanguage model, SioCmsContext _context = null, IDbContextTransaction _transaction = null)
        ...
        public override RepositoryResponse<bool> RemoveRelatedModels(ReadAndroidViewModel view, SioCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
        ...
        public override async Task<RepositoryResponse<bool>> RemoveRelatedModelsAsync(ReadAndroidViewModel view, SioCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
            foreach (var culture in Cultures.Where(c => c.Specificulture != Specificulture))
            {
                var lang = _context.SioLanguage.First(c => c.Keyword == Keyword && c.Specificulture == culture.Specificulture);
            ...
            , SioCmsContext _context = null, IDbContextTransaction _transaction = null)
        {
            ...
            {
                var error = UnitOfWorkHelper<SioCmsContext>.HandleException<ReadAndroidViewModel>(ex, isRoot, transaction);
