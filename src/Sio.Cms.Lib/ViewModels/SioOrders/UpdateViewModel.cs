...
namespace Sio.Cms.Lib.ViewModels.SioOrders
{
    public class UpdateViewModel
        : ViewModelBase<SioCmsContext, SioOrder, UpdateViewModel>
    {
        #region Properties
        ...
        [JsonProperty("status")]
        public SioOrderStatus Status { get; set; }
        ...
        public UpdateViewModel(SioOrder model, SioCmsContext _context = null, IDbContextTransaction _transaction = null)
