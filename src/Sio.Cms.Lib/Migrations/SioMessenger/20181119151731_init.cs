    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sio_messenger_hub_room", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "sio_messenger_team",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sio_messenger_team", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "sio_messenger_user",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sio_messenger_user", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "sio_messenger_user_device",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sio_messenger_user_device", x => new { x.UserId, x.DeviceId });
                });

            migrationBuilder.CreateTable(
                name: "sio_messenger_message",
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sio_messenger_message", x => x.Id);
                    table.ForeignKey(
                        name: "FK_messenger_message_messenger_hub_room",
                        column: x => x.RoomId,
                        principalTable: "sio_messenger_hub_room",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_messenger_message_messenger_team",
                        column: x => x.TeamId,
                        principalTable: "sio_messenger_team",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_messenger_message_messenger_user",
                        column: x => x.UserId,
                        principalTable: "sio_messenger_user",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateTable(
                name: "sio_messenger_nav_room_user",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sio_messenger_nav_room_user", x => new { x.RoomId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "sio_messenger_nav_team_user",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_sio_messenger_nav_team_user", x => new { x.TeamId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "sio_messenger_nav_room_user",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_messenger_nav_team_user_UserId",
                table: "sio_messenger_nav_team_user",
                column: "UserId");
        }
