...
using Sio.Identity.Data;

namespace Sio.Cms.Lib.Models.Account
{
    public partial class SioCmsAccountContext : DbContext
    {
        ...
        public SioCmsAccountContext(DbContextOptions<ApplicationDbContext> options)
                    : base(options)
        {
        }

        public SioCmsAccountContext()
        {
        }
