...
using System.Web;
using Sio.Cms.Lib.ViewModels.SioPageArticles;
...
namespace Sio.Cms.Api.Controllers.v1
{
    ...
    public class ApiPageArticleController :
        BaseGenericApiController<SioCmsContext, SioPageArticle>
    {
        ...
        public async Task<RepositoryResponse<SioPageArticle>> DeleteAsync(int pageId, int articleId)
        {
        ...
        public async Task<ActionResult<JObject>> Details(string viewType, int? pageId, int? articleId)
        {
            ...
            switch (viewType)
            {
                ...
                default:
                    ...
                    {
                        Expression<Func<SioPageArticle, bool>> predicate = model => model.CategoryId == pageId && model.ArticleId == articleId && model.Specificulture == _lang;
        ...
        public async Task<RepositoryResponse<SioPageArticle>> SaveFields(int pageId, int articleId, [FromBody]List<EntityField> fields)
        {
            if (fields != null)
            {
                var result = new RepositoryResponse<SioPageArticle>() { IsSucceed = true };
            ...
            return new RepositoryResponse<SioPageArticle>();
        }
            ...
            [FromBody] RequestPaging request)
        {
            ...
            Expression<Func<SioPageArticle, bool>> predicate = model =>
