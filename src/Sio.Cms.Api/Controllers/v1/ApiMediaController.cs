...
namespace Sio.Cms.Api.Controllers.v1
{
    ...
    public class ApiMediaController :
      BaseGenericApiController<SioCmsContext, SioMedia>
    {
        ...
        [HttpGet, HttpOptions]
        [Route("delete/{id}")]
        public async Task<RepositoryResponse<SioMedia>> DeleteAsync(int id)
        {
                    ...
                    else
                    {
                        ...
                        RepositoryResponse<UpdateViewModel> result = new RepositoryResponse<UpdateViewModel>()
                        {
                            ...
                            Data = new UpdateViewModel(model)
                            {
                                ...
                                Status = SioContentStatus.Published,
                            }
                        };
            ...
            [FromBody] RequestPaging request)
        {
            ...
            Expression<Func<SioMedia, bool>> predicate = model =>
                        model.Specificulture == _lang
