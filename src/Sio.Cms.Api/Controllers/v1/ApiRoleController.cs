...
using Sio.Cms.Lib.ViewModels.Account.SioRoles;
...
namespace Sio.Cms.Api.Controllers.v1
{
    ...
    public class ApiRoleController : BaseApiController
    {
        ...
        public async Task<RepositoryResponse<Lib.ViewModels.SioPortalPageRoles.ReadViewModel>> Update(
            [FromBody] Lib.ViewModels.SioPortalPageRoles.ReadViewModel model)
        {
            var result = new RepositoryResponse<Lib.ViewModels.SioPortalPageRoles.ReadViewModel>() { IsSucceed = true, Data = model };
            if (model != null)
            {
                if (model.IsActived)
                {
            ...
            return new RepositoryResponse<Lib.ViewModels.SioPortalPageRoles.ReadViewModel>();
        }
